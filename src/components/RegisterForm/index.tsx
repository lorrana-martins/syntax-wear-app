...
export const RegisterForm = () => {
    ...
    return (
        <form className="text-black space-y-3">
            ...
            <button disabled={isSubmitting} className="bg-[#6433EB] text-white font-semibold uppercase rounded-md py-3 transition-all hover:bg-[#4028c7] disabled:opacity-50 w-full cursor-pointer" >
